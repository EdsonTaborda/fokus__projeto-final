const bntAdicionarFormulario = document.querySelector('.app__button--add-task')
...
function criaElementoTarefa(tarefa) {
    ...
    botao.onclick = () => {
        //debugger
        const novaDescricao = prompt("Qual será o novo nome da terefa?")
...
bntAdicionarFormulario.addEventListener('click', () => {
